    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        <div class="col-md-6">
            <nav class="breadcrumb pd-0 mg-0 tx-12">
              ...
              <span class="breadcrumb-item active">Top Category</span>
            </nav>
        </div>
        <div class="col-md-6">
      ...
      <div class="row row-sm mg-t-20">
          <div class="col-sm-5">
            <div class="card shadow-base bd-0">
              <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
                <h6 class="card-title tx-uppercase tx-12 mg-b-0">Add Top Category</h6>
                <span class="tx-12 tx-uppercase">{{date('F d, Y')}}</span>
              </div><!-- card-header -->
              <div class="card-body d-xs-flex justify-content-between align-items-center">
                <form method="post" action="{{route('admin.save-top-category')}}" enctype="multipart/form-data">
                  @csrf
                  <div class="row mg-b-25">
                    <div class="col-lg-12">
                        <div class="form-group">
                        <select class="form-control select2" name="category[]" data-placeholder="Choose Category" multiple>
          ...
          <div class="col-sm-7 mg-t-20 mg-sm-t-0">
            <div class="card shadow-base bd-0">
              <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
                <h6 class="card-title tx-uppercase tx-12 mg-b-0">Top Category List</h6>
                <span class="tx-12 tx-uppercase">{{date('F d, Y')}}</span>
              </div><!-- card-header -->
              <div class="card-body d-xs-flex justify-content-between align-items-center">
                <div class=infinite-scroll>
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <img src="{{asset('uploads/category/'.$list->category->image)}}" alt="{{$list->category->name}}" class="defaultimgcss">
...
<form method="post" action="{{route('admin.remove-top-category')}}" id="RemoveForm">@csrf<input type="hidden" name="removeId" id="removeId"></form>

@push('style')
<title>Top Category : Ebizzmart</title>
