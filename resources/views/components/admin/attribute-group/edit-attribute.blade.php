<div class="br-mainpanel">
      <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">Edit Attribute Group</span>
        </nav>
      </div><!-- br-pageheader -->
      <x-admin.alert/>
      <div class="br-pagebody">
        <div class="br-section-wrapper">
          <form method="post" action="{{route('admin.update-attribute-group')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-layout form-layout-1">
                <div class="row mg-b-0 after-add-more">
                    <div class="col-lg-12">
                        ...
                        <input class="form-control" type="text" name="name" value="{{$lists->title}}" placeholder="Attribute Group Name Here...">
...
@push('style')
    ...
    <title>Edit Attribute Group : Ebizzmart</title>
@endpush