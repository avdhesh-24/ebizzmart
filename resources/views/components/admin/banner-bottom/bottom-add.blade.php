<div class="br-mainpanel">
      <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">Add Banner Bottom</span>
        </nav>
      </div><!-- br-pageheader -->
      <x-admin.alert/>
      <div class="br-pagebody">
        <div class="br-section-wrapper">
          <form method="post" action="{{route('admin.save-bottom')}}" enctype="multipart/form-data">
            @csrf
          <div class="form-layout form-layout-1">
            <div class="row mg-b-25">
                <div class="col-lg-8">
                    ...
                    <input class="form-control" type="text" name="title" value="{{old('title')}}" placeholder="Banner Text Here...">
                    </div>
                </div><!-- col-4 -->
                ...
                <div class="col-lg-4">
                    ...
                    <input class="form-control" type="text" name="button" value="{{old('button')}}" placeholder="Button Name Here...">
                    </div>
                </div><!-- col-4 -->
                <div class="col-lg-12">
                    <div class="form-group">
                    <label class="form-control-label">Button Link: </label>
                    <input class="form-control" type="text" name="link" value="{{old('link')}}" placeholder="Button Link Here...">
                    </div>
                </div><!-- col-4 -->
                <div class="col-lg-4">
                    <div class="form-group">
...
@push('style')
<title>New Banner Bottom : Ebizzmart</title>
@endpush
